...
export default function Journey() {
  return (
    <section id='perjalanan' className='bg-accent/7 py-16 md:py-32'>
      <div className='mx-auto max-w-6xl px-4 grid grid-cols-1 items-center justify-center gap-10 md:grid-cols-9'>
        <FadeIn className='col-span-1 space-y-4 text-center md:text-left md:col-span-3'>
        ...
        <div className='col-span-1 relative md:col-span-6'>
          ...
          <FadeInStagger className='grid grid-cols-1 gap-10 sm:grid-cols-3'>
