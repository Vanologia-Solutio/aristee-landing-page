  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-4xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        'accent-outline':
          'border border-accent bg-background text-primary hover:bg-accent/80 hover:text-background aria-expanded:bg-accent/80 aria-expanded:text-background',
        outline:
        ...
        whatsapp:
          'border border-green-600 bg-background text-green-600 hover:bg-green-600/80 hover:text-background aria-expanded:bg-green-600/80 aria-expanded:text-background',
